...
class Log:
    ...
    # def check_and_delete_logs(self, log_files: list, max_size: int = 10000000) -> None:
    #     """
    #     Checks the size of each log file in the list and deletes it if it exceeds the max_size.
    #
    #     Args:
    #         log_files (list): A list of log file paths to check.
    #         max_size (int, optional): The maximum size of the log files in bytes. Defaults to 50,000,000 bytes (approx. 50 MB).
    #
    #     Returns:
    #         None: None
    #     """
    ...
    #
    #             # If the log file size exceeds the max_size, delete the log file
